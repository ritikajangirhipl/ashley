...
var KTSelect2 = function() {
    ...
    var demos = function() {
        // basic
        $('#verification_country').select2({
            placeholder: 'Search and Filter by Select Country'
        });
        $('#verification_provider_type').select2({
            placeholder: 'Search and Filter by Select Verification Provider Type'
        });
        ...
        $('#verification_mode').select2({
            placeholder: 'Search and Filter by Select Verification Mode'
        });
