...
document.addEventListener("DOMContentLoaded", function () {
    ...
    searchInputs.forEach(input => {
        input.addEventListener("input", function () {
            ...
            const listItems = card.querySelectorAll(".search-list li");
            const noResultMessage = card.querySelector(".no-result");
        ...
        build: function() {
            ...
            window.addEventListener('scroll', function() {
                ...
                if (
                    ...
                    if (st > 50 && lastScrollTop < st) { // down scroll mode
