                    ...
                    <div class="row align-items-center">
                        <div class="col-lg-6 d-none d-lg-block">
                            <div class="auth_image">
                                <img src="{{asset('assets/images/login.webp')}}" alt="Login" class="img-fluid">
                            </div>
                        </div>
                        <div class="col-lg-6">
                            <div class="fields-blog bg-white radius-15">
                                ...
                                <form method="POST" action="{{ route('login')}}">
                                 @csrf
                                    ...
                                    <div class="other-login-field mt-3">
                                        <ul class="d-flex p-0 m-0">
                                            <li><a href="#"><img src="images/google-withbg.svg" alt="google"> Sign In With Google</a></li>
                                            <li><a href="#"><img src="images/fb-withbg.svg" alt="Facebbok"> Sign In With Facebook</a></li>
                                        </ul>
                                    </div> -->
                                </form>
                            </div>
