                                ...
                                <div class="card-body">												
                                    <form class="form">
                                        <div class="row">
                                            ...
                                            <div class="col-md-6 col-lg-6">
                                                <div class="form-group">
                                                    <label class="col-form-label pt-0">Subjects First Name</label>
                                                    <input type="text" class="form-control" placeholder="Subjects First Name">
                                                </div>
                                            </div>
                                            <div class="col-md-6 col-lg-4">
                                                <div class="form-group">
                                                    <label class="col-form-label pt-0">Any Middle Names</label>
                                                    <input type="text" class="form-control" placeholder="Any Middle Names">
                                                </div>
                                            </div>
                                            <div class="col-md-6 col-lg-4">
                                                <div class="form-group">
