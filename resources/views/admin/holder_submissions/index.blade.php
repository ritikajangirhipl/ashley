        ...
        <div class="card">
            <div class="card-header card-header-primary">
                <h4 class="card-title float-left">
                    {{ trans('cruds.holder_submissions.title') }} {{ trans('global.list') }}
                </h4>
                @can('student_create')
                    <a class="btn btn-success btn-sm float-right" title="{{ trans('global.add') }} {{ trans('cruds.holder_submissions.title_singular') }}" href="{{ route('admin.holder-submissions.create') }}">
