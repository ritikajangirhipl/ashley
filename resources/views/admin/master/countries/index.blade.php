...
<div class="card">
    <div class="card-header card-header-primary">
        <h4 class="card-title float-left">
            {{ trans('cruds.country.title') }} {{ trans('global.list') }}
        </h4>
        @can('country_create')
            <a class="btn btn-success btn-sm float-right" id="addBtn" title="{{ trans('global.add') }} {{ trans('cruds.country.title_singular') }}" href="javascript:void(0);">
  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      <div class="modal-header">
        <h3 class="m-0 font-weight-bold" id="modal_title">{{ trans('global.add') }} {{ trans('cruds.country.title_singular') }}</h3>
...
<script type="text/javascript">
    $(document).ready( function(){
        $("#addBtn").on('click', function () {
            ...
            $('#modal_title').text("{{ trans('global.add') }} {{ trans('cruds.country.title_singular') }}");
      ...
      $(document).on("click", ".edit-record", function() {
        $('.my-modal-content').html('');
        $('#modal_title').text("{{ trans('global.edit') }} {{ trans('cruds.country.title_singular') }}");
        $('#pageloader').css('display', 'flex');
      ...
      // Update Status 
      $(document).on('click','.country_status_cb', function(){
        var $this = $(this);
        ...
        .then(function(result) {
            if (result.isConfirmed) {  
                $.ajax({
                    ...
                    dataType: 'json',
                    data: { _token: csrf_token, country_id: countryId, status: status },
                    success: function (response) {
