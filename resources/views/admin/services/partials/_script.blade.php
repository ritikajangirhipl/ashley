    ...
    $(document).ready(function () {
        ...
        $("#services-form").validate({
            ...
            messages: {
                ...
                sub_category_id: {
                    required: "{{ trans('validation.required', ['attribute' => 'sub-category']) }}"
                },
                verification_mode_id: {
                    required: "{{ trans('validation.required', ['attribute' => 'verification mode']) }}"
                },
                verification_summary: {
                    required: "{{ trans('validation.required', ['attribute' => 'verification summary']) }}"
                },
                verification_provider_id: {
                    required: "{{ trans('validation.required', ['attribute' => 'verification provider']) }}"
                },
                verification_duration: {
                    required: "{{ trans('validation.required', ['attribute' => 'verification duration']) }}"
                },
                evidence_type_id: {
                    required: "{{ trans('validation.required', ['attribute' => 'evidence type']) }}"
                },
                evidence_summary: {
                    required: "{{ trans('validation.required', ['attribute' => 'evidence summary']) }}"
                },
                service_partner_id: {
                    required: "{{ trans('validation.required', ['attribute' => 'service partner']) }}"
                },
                service_currency: {
                    required: "{{ trans('validation.required', ['attribute' => 'service currency']) }}"
                },
                local_service_price: {
                    required: "{{ trans('validation.required', ['attribute' => 'local service price']) }}"
                },
                usd_service_price: {
                    required: "{{ trans('validation.required', ['attribute' => 'usd service price']) }}"
                },
                subject: {
                    required: "{{ trans('validation.required', ['attribute' => 'subject']) }}"
                },
                contact_address: {
