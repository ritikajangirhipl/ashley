            ...
            <div class="row">
                <div class="col-md-6">
                    <div class="form-group d-flex view-listing">
                        ...
                        <p class="ml-2 mb-0">{{ ucwords($service->country->name) ?? 'N/A' }}</p>
                    </div>
                </div>
                ...
                <div class="col-md-6">
                    <div class="form-group d-flex view-listing">
                        ...
                        <p class="ml-2 mb-0">{{ ucwords($service->category->name) ?? 'N/A' }}</p>
                    </div>
                </div>
                ...
                <div class="col-md-6">
                    <div class="form-group d-flex view-listing">
                        ...
                        <p class="ml-2 mb-0">{{ ucwords($service->subCategory->name) ?? 'N/A' }}</p>
                    </div>
                </div>
                ...
                <div class="col-md-6">
                    <div class="form-group d-flex view-listing">
                        ...
                        <p class="ml-2 mb-0">{{ $subjects[$service->subject] ?? 'N/A' }}</p>
                    </div>
                </div>
                ...
                <div class="col-md-6">
                    <div class="form-group d-flex view-listing">
                        ...
                        <p class="ml-2 mb-0">{{ $service->verificationMode->name ?? 'N/A' }}</p>
                    </div>
                </div>
                ...
                <div class="col-md-6">
                    <div class="form-group d-flex view-listing">
                        ...
                        <p class="ml-2 mb-0">{{ $service->verification_summary ?? 'N/A' }}</p>
                    </div>
                </div>
                ...
                <div class="col-md-6">
                    <div class="form-group d-flex view-listing">
                        ...
                        <p class="ml-2 mb-0">{{ $service->verificationProvider->name ?? 'N/A' }}</p>
                    </div>
                </div>
                ...
                <div class="col-md-6">
                    <div class="form-group d-flex view-listing">
                        ...
                        <p class="ml-2 mb-0">{{ $service->verification_duration ?? 'N/A' }}</p>
                    </div>
                </div>
                ...
                <div class="col-md-6">
                    <div class="form-group d-flex view-listing">
                        ...
                        <p class="ml-2 mb-0">{{ $service->evidenceType->name ?? 'N/A' }}</p>
                    </div>
                </div>
                ...
                <div class="col-md-6">
                    <div class="form-group d-flex view-listing">
                        ...
                        <p class="ml-2 mb-0">{{ $service->evidence_summary ?? 'N/A' }}</p>
                    </div>
                </div>
                ...
                <div class="col-md-6">
                    <div class="form-group d-flex view-listing">
                        ...
                        <p class="ml-2 mb-0">{{ $service->servicePartner->name ?? 'N/A' }}</p>
                    </div>
                </div>
                ...
                <div class="col-md-6">
                    <div class="form-group d-flex view-listing">
                        ...
                        <p class="ml-2 mb-0">{{ $service->country->currency_name ?? 'N/A' }}</p>
                    </div>
                </div>
                ...
                <div class="col-md-6">
                    <div class="form-group d-flex view-listing">
                        ...
                        <p class="ml-2 mb-0">{{ $service->local_service_price ?? 'N/A' }}</p>
                    </div>
                </div>
                ...
                <div class="col-md-6">
                    <div class="form-group d-flex view-listing">
                        ...
                        <p class="ml-2 mb-0">{{ $service->usd_service_price ?? 'N/A' }}</p>
                    </div>
                </div>
                ...
                <div class="col-md-6">
                    <div class="form-group d-flex view-listing">
                        ...
                        <p class="ml-2 mb-0">{{ $input_details[$service->subject_name] ?? 'N/A' }}</p>
                    </div>
                </div>
                ...
                <div class="col-md-6">
                    <div class="form-group d-flex view-listing">
                        ...
                        <p class="ml-2 mb-0">{{ $input_details[$service->copy_of_document_to_verify] ?? 'N/A' }}</p>
                    </div>
                </div>
                ...
                <div class="col-md-6">
                    <div class="form-group d-flex view-listing">
                        ...
                        <p class="ml-2 mb-0">{{ $input_details[$service->reason_for_request] ?? 'N/A' }}</p>
                    </div>
                </div>
                ...
                <div class="col-md-6">
                    <div class="form-group d-flex view-listing">
                        ...
                        <p class="ml-2 mb-0">{{ $input_details[$service->subject_consent_requirement] ?? 'N/A' }}</p>
                    </div>
                </div>
                ...
                <div class="col-md-6">
                    <div class="form-group d-flex view-listing">
                        ...
                        <p class="ml-2 mb-0">{{ $input_details[$service->name_of_reference_provider] ?? 'N/A' }}</p>
                    </div>
                </div>
                ...
                <div class="col-md-6">
                    <div class="form-group d-flex view-listing">
                        ...
                        <p class="ml-2 mb-0">{{ $input_details[$service->address_information] ?? 'N/A' }}</p>
                    </div>
                </div>
                <div class="col-md-6">
                    <div class="form-group d-flex view-listing">
                        <h6 class="mb-0"><b>{{ trans('cruds.services.fields.location') }}:</b></h6>
                        <p class="ml-2 mb-0">{{ $input_details[$service->location] ?? 'N/A' }}</p>
                    </div>
                </div>
                ...
                <div class="col-md-6">
                    <div class="form-group d-flex view-listing">
                        ...
                        <p class="ml-2 mb-0">{{ $input_details[$service->gender] ?? 'N/A' }}</p>
                    </div>
                </div>
                <div class="col-md-6">
                    <div class="form-group d-flex view-listing">
                        <h6 class="mb-0"><b>{{ trans('cruds.services.fields.marital_status') }}:</b></h6>
                        <p class="ml-2 mb-0">{{ $input_details[$service->marital_status] ?? 'N/A' }}</p>
                    </div>
                </div>
                ...
                <div class="col-md-6">
                    <div class="form-group d-flex view-listing">
                        ...
                        <p class="ml-2 mb-0">{{ $input_details[$service->registration_number] ?? 'N/A' }}</p>
                    </div>
                </div>
