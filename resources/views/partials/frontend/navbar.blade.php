    ...
    <div class="container d-flex align-items-stretch justify-content-between">
        ...
        <div class="topbar">
            ...
            <div class="dropdown">
                ...
                <div class="dropdown-menu p-0 m-0 dropdown-menu-right dropdown-menu-anim-up dropdown-menu-lg">
                    <form>
                        <div class="d-flex flex-column pt-12 bgi-size-cover bgi-no-repeat rounded-top" style="background-image: url('{{ asset('assets/images/bg-1.jpg') }}');">
            ...
            <div class="dropdown">
                ...
                <div class="dropdown-menu p-0 m-0 dropdown-menu-right dropdown-menu-anim-up dropdown-menu-lg">
                    <div class="d-flex flex-column flex-center py-10 bgi-size-cover bgi-no-repeat rounded-top" style="background-image: url('{{ asset('assets/images/bg-1.jpg') }}');">
            ...
            <div class="dropdown">
                ...
                <div class="dropdown-menu p-0 m-0 dropdown-menu-right dropdown-menu-xl dropdown-menu-anim-up">
                    <form>
                        <div class="d-flex align-items-center py-10 px-8 bgi-size-cover bgi-no-repeat rounded-top" style="background-image: url('{{ asset('assets/images/bg-1.jpg') }}');">
                        ...
                        <div class="scroll scroll-push" data-scroll="true" data-height="250" data-mobile-height="200" >
                            <div class="d-flex align-items-center justify-content-between p-8">
                                ...
                                <a href="#" class="symbol symbol-70 flex-shrink-0">
                                    <img src="{{asset('assets/images/img-1.jpg')}}" title="" alt=""/>
                                </a>
                            </div>
                            ...
                            <div class="d-flex align-items-center justify-content-between p-8">
                                ...
                                <a href="#" class="symbol symbol-70 flex-shrink-0">
                                    <img src="{{asset('assets/images/img-2.jpg')}}" title="" alt=""/>
                                </a>
                            </div>
                            <div class="separator separator-solid"></div>
                            <div class="d-flex align-items-center justify-content-between p-8">
                                ...
                                <a href="#" class="symbol symbol-70 flex-shrink-0">
                                    <img src="{{asset('assets/images/img-3.jpg')}}" title="" alt=""/>
                                </a>
                            </div>    						
                            <div class="separator separator-solid"></div>
                            <div class="d-flex align-items-center justify-content-between p-8">
                                ...
                                <a href="#" class="symbol symbol-70 flex-shrink-0">
                                    <img src="{{asset('assets/images/img-4.jpg')}}" title="" alt=""/>
                                </a>
                            </div>
                        </div>
                        <div class="p-8">
