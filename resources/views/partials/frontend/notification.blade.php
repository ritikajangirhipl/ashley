...
<div id="kt_quick_panel" class="offcanvas offcanvas-right pt-5 pb-10">
    ...
    <div class="offcanvas-content px-10">
        <div class="tab-content">
            <div class="tab-pane fade show pt-3 pr-5 mr-n5 active scroll ps ps--active-y" id="kt_quick_panel_logs" role="tabpanel" style="height: 513px; overflow: hidden;">
                <div class="mb-15">
                ...
                <div class="ps__rail-y" style="top: 0px; height: 513px; right: 0px;"><div class="ps__thumb-y" tabindex="0" style="top: 0px; height: 300px;"></div></div>
            </div>
            <div class="tab-pane fade pt-2 pr-5 mr-n5 scroll ps" id="kt_quick_panel_notifications" role="tabpanel" style="height: 513px; overflow: hidden;">
            ...
            <div class="tab-pane fade pt-3 pr-5 mr-n5 scroll ps" id="kt_quick_panel_settings" role="tabpanel" style="height: 513px; overflow: hidden;">
                <form class="form">
                    <div>
