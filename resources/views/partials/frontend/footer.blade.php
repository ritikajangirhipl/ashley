<div class="footer kt-grid__item bgi-position-center-center bgi-size-cover bgi-no-cover" id="kt_footer" style="background-image: url('{{ asset('assets/images/bg-2.jpg') }}');">
            ...
            <div class="col-lg-4 my-lg-0 my-5">
                ...
                <div class="d-flex align-items-center">
                    <div class="d-flex flex-column mr-18">
                        ...
                        <a href="#" class="py-2 text-white opacity-55 text-hover-primary">Dashboart Widgets</a>
                ...
                <form class="rounded" style="background-color: rgba(0, 0, 0, 0.2);">
                    <div class="input-group p-2 align-items-center">
                        ...
                        <div class="input-group-append p-0 mr-1">
                            <button class="btn btn-fh btn-sm btn-primary px-6 rounded-left" type="button">Join</button>
                        </div>
                    </div>
                </form>
            </div>
    ...
    <div class="container py-8">
        <div class="d-flex align-items-center justify-content-between flex-lg-row flex-column">
            <div class="d-flex align-items-center order-lg-1 order-2">
                <img alt="Logo" src="{{asset('assets/images/logo-white-main.png')}}" class="logo-sticky max-h-40px" />
                <span class="text-muted font-weight-bold mx-2">2025©</span>
                <a href="#" target="_blank" class="text-primary text-hover-primary">Ashley Hargreeves</a>
            </div>
            <div class="d-flex align-items-center order-lg-2 order-1 mb-lg-0 mb-5">
                <a href="#" target="_blank" class="text-white opacity-55 pl-0 mr-6 text-hover-primary">About</a>
                <a href="#" target="_blank" class="text-white opacity-55 pr-0 text-hover-primary">Contact</a>
            </div>
        </div>
    </div>
</div>