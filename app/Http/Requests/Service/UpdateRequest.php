...
class UpdateRequest extends FormRequest
{
    ...
    public function rules()
    {
        return [
            ...
            "local_service_price" => 'required|numeric|min:0',
            "usd_service_price" => 'required|numeric|min:0',
    ...
    public function messages()
    {
        return [
            ...
            'local_service_price.min' => 'Local Service Price cannot be negative.',
            'usd_service_price.min' => 'USD Service Price cannot be negative.',
