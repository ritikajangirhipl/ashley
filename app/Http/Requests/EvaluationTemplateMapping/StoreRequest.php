    ...
    public function rules()
    {
        return [
            ...
            'issuer_curriculum_details_id' => [
                ...
                'unique:evaluation_template_mappings,issuer_curriculum_details_id,NULL,NULL,receiver_curriculum_details_id,'.$this->receiver_curriculum_details_id
            ],
            'receiver_curriculum_details_id' => [
                'required',
                'integer',
                'exists:curriculum_details,id',
                'unique:evaluation_template_mappings,receiver_curriculum_details_id,NULL,NULL,issuer_curriculum_details_id,'.$this->issuer_curriculum_details_id
            ],
            'status' => [
                'required',
            ],
