...
class StudentsController extends Controller
{
    ...
    public function index(StudentsDataTable $dataTable)
    {
        ...
        $pageTitle = trans('panel.page_title.students.list');
        return $dataTable->render('admin.students.index', compact('pageTitle'));
    }

    public function create(){
        abort_if(Gate::denies('student_create'), Response::HTTP_FORBIDDEN, '403 Forbidden');
        $pageTitle           = trans('panel.page_title.students.add');
        $status              = $this->status;
        return view('admin.students.create', compact('pageTitle','status'));
    }
